(function () {
    ...
    angular
        .module('hiraApp.data')
        .factory('repository.projects', RepositoryProject);

    RepositoryProject.$inject = ['model','repository.abstract', 'common'];

    function RepositoryProject(model, AbstractRepository, common) {
