(function () {
    ...
    angular
        .module('hiraApp.data')
        .factory('repository.extras', RepositoryExtras);

    RepositoryExtras.$inject = ['model','repository.abstract', 'common'];

    function RepositoryExtras(model, AbstractRepository, common) {
