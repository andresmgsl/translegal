(function () {
    ...
    common.$inject = ['$location', '$q', '$rootScope', '$timeout', '$http', '$state', '$stateParams', '$window'];

    /* @ngInject */
    function common($location, $q, $rootScope, $timeout, $http, $state, $stateParams, $window) {
        //var throttles = {};
        ...
        function toggleAddArray(array, item){
