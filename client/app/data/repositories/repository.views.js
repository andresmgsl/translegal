(function () {
    ...
    angular
        .module('hiraApp.data')
        .factory('repository.views', RepositoryViews);

    RepositoryViews.$inject = ['model','repository.abstract', 'common'];

    function RepositoryViews(model, AbstractRepository, common) {
